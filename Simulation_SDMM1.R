...
## for the stratified decision-making model 
...
# define simulated EMV matrix (SIM_EMV)
SIM_EMV <- matrix(0,nrow=B,ncol=YZ)
...
SIM_EMV
rowMeans(SIM_EMV)
format(round(rowMeans(SIM_EMV), 2), nsmall = 2)
